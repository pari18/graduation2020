...
<div class="col-lg-16 mt-lg-0 mt-sm-5 mt-4">
     <h3 align="center" style="background:linear-gradient(to right, #42a5f5, #86c9ff); padding-top:20px; padding-bottom:20px; color:white;">View &amp; Download Assignment</h3><hr/><br>
      ...
      $result = $conn->query($sql);
       if ($result->num_rows > 0) { // if one or more rows are returned do following
            while($ro = $result->fetch_assoc()){    
                ...
                echo "<tr><td>".$ro["id"]."</td><td>".$ro["subject_name"]."</td><td>".$ro["course"]."</td><td>".$ro["sem"]."</td><td>".$ro["num"]."</td><td>".$ro["assignment_date"]."</td>";
