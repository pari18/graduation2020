...
<!--//skycons-icons-->
      ...
      <style>
     input[type=text], input[type=password], input[type=tel], input[type=email], input[type=file], input[type=date], select, textarea {
  width: 100%;
  padding: 12px;
...
<body bgcolor="grey">
   ...
   <!--/content-inner-->
	...
	<div class="container" style="margin-top: 1%;">
           <div class="row">
               <h3 align="center" style="background:linear-gradient(to right, #42a5f5, #86c9ff); padding-top:20px; padding-bottom:20px; color:white;">Upload Assignment</h3><hr/><br>
  ...
  <form method="post" action="controller.php" align="left" enctype="multipart/form-data">
    ...
    <select name = "course" id="pwd" required>
     ...
     <select  name = "sem" id="pwd" required>
    ...
    <label for="lname">Upload Assignment</label>
    <input type="file" name="pdf" multiple placeholder="select the file">

	
	<label for="fname">Assignment Number</label>
   <select  name = "an" id="an" required>
      ...
      <label for="fname">Date of submission</label>
    <input type="date" id="adate" name="adate" placeholder="Enter subject of news.." required>
      
      
      <input type="hidden" name="uname" value="<?php echo $adi;?>">
    <input type="submit" value="Submit" name="upassign">
  </form>
