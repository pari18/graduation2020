...
<div class="container" style="margin-top: 3%;">
   ...
   <div id="div1" class="targetDiv">
       <h3 align="center" style="background:linear-gradient(to right, #42a5f5, #86c9ff); padding-top:20px; padding-bottom:20px; color:white;">Add/Insert Ground Detail</h3><hr/><br>
  ...
  <form method="post" action="controller.php" align="left" enctype="multipart/form-data" validate>
    ...
    <input type="text" name="SUBJECT" placeholder="Enter subject of query" required>
	
      
    <label for="lname">Ground image</label>
      <textarea type="text" name="image" style="height:100px;" multiple placeholder="Write message for query" required></textarea>

    <input type="submit" value="Submit" name="addg">
  </form>
      <br>
       <br>
            <br><br><br>
			...
			<!--/down-->
							<div class="down" style="height: 200px;">	
									  <a href="admin.php"><img src="<?php echo $rows['profile']; ?>" height="100" width="100"></a>
