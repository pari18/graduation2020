...
<div class="col-lg-16 mt-lg-0 mt-sm-5 mt-4">
     <h3 align="center" style="background:linear-gradient(to right, #42a5f5, #86c9ff); padding-top:20px; padding-bottom:20px; color:white;">Qurey Status</h3><hr/><br>
<table width="80%" align="center" cellpadding="4" cellspacing="0" class="zebra zebra2">
 <tr>
<th>ID</th>
<th>Subject</th>
<th>Name</th>
      ...
      $result = $conn->query($sql);
       if ($result->num_rows > 0) { // if one or more rows are returned do following
            while($ro = $result->fetch_assoc()){    
                ...
                echo "<tr><td>".$ro["id"]."</td><td>".$ro["sub"]."</td><td>".$ro["uname"]."</td><td>".$ro["msg"]."</td><td>1</td>";
                echo "</tr>";
            }
        }
    ?>
